  ...
  // left hand
   ...
   RESET,    _______,  _______,  _______,  _______,  _______,
        ...
        // right hand
                     ...
                     _______,  KC_MS_BTN1,  KC_MS_UP, 	KC_MS_BTN2, KC_WH_U, KC_F12,
                     _______,  KC_MS_LEFT,	KC_MS_DOWN, KC_MS_RIGHT,KC_WH_D, _______,
                     KC_MUTE,  KC_VOLD,  	KC_VOLU,  	KC_MPLY,  	_______, RESET,
                                        	_______,  	_______,
        KC_SPC, LT(_FN, KC_BSPC),
        CTL_T(KC_PGUP), KC_PGDN,
        KC_LALT, KC_LGUI),
